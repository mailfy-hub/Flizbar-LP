...
export default function Footer({
  ...
  return (
    <div className="mx-4 md:mx-0">
      <div className="flex flex-col md:flex-row w-full gap-12 md:gap-20 mt-[64px] md:justify-between">
        <div>
          <div
            className="w-[125px] h-[32px] mb-[40px]"
      ...
      <div className="flex flex-col md:flex-row w-full justify-between md:items-center text-center mt-[100px] font-thin">
        ...
        <div
          className={`flex justify-center gap-x-[24px] text-[14px] font-thin mt-8 md:mt-0 text-center ${inter.className}`}
        >
          <p>{footer.useTerms}</p>
          <p>{footer.privacy}</p>
        </div>
