...
export default function AdvantagesCard({ languages }: { languages: any }) {
  ...
  return (
    <div className="flex flex-col w-full h-[calc(100vh-165px)]">
      <div className="flex flex-col justify-center items-center w-full">
        <p className="text-[#C89305] font-semibold text-[14px] mt-4">{languages.page.default.advantages.title}</p>
        ...
        <div className="flex flex-col-reverse md:flex-row w-full lg:justify-between 2xl:mt-[100px]">
          <div className="flex flex-col 2xl:justify-between">
            <div>
              <p className="max-w-[567px] text-[32px] md:text-[40px] 2xl:text-[48px] mb-[20px] mt-6 md:mt-0 leading-[40px] md:leading-[55px]">
                {languages.page.default.advantages.menu.first.title}
              </p>
              <p className="max-w-[727px] text-[16px] md:text-[18px] 2xl:text-[20px]">
